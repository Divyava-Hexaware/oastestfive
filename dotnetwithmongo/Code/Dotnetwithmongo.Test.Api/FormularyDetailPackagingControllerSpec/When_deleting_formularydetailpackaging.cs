...
{
    public class When_deleting_formularydetailpackaging : UsingFormularyDetailPackagingControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _formularydetailpackagingService.Delete(Id).Returns(true);
        }
        ...
        {
            _formularydetailpackagingService.Received(1).Delete(Id);
