...
describe('testing view PlanDetailAdd Component', () => {
    ...
    test('should be able to give inputs to all fields of PlanDetail add form', async () => {
        ...
        fireEvent.change(DrugTierElement, { target: { value: 22 } })
        ...
        fireEvent.change(CostAmountElement, { target: { value: 11 } })
        fireEvent.change(CostPercentageElement, { target: { value: 2 } })
        fireEvent.change(MinAmountElement, { target: { value: 91 } })
        fireEvent.change(MaxAmountElement, { target: { value: 53 } })
