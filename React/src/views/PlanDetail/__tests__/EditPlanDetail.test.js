...
describe('testing view of PlanDetailEdit Component', () => {
    ...
    test('should be able to give inputs to all fields of PlanDetail edit form', async () => {
        ...
        fireEvent.change(DrugTierElement, { target: { value: 63 } })
        ...
        fireEvent.change(CostAmountElement, { target: { value: 19 } })
        fireEvent.change(CostPercentageElement, { target: { value: 76 } })
        fireEvent.change(MinAmountElement, { target: { value: 45 } })
        fireEvent.change(MaxAmountElement, { target: { value: 91 } })
        ...
        expect(DrugTierElement.value).toBe(63)
        expect(DrugTierCaptionElement.value).toBe('DrugTierCaption')

        expect(DaysSupplyElement.value).toBe('DaysSupply')

        expect(CostAmountElement.value).toBe(19)
        expect(CostPercentageElement.value).toBe(76)
        expect(MinAmountElement.value).toBe(45)
        expect(MaxAmountElement.value).toBe(91)
